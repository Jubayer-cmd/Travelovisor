    ...
    <div>
      <div className="p-6 container md:w-2/3 xl:w-auto mx-auto flex flex-col xl:items-stretch justify-between xl:flex-row">
        ...
        <div className="w-full xl:w-1/2 xl:pl-40 xl:py-28">
          <h1 className="text-2xl md:text-4xl xl:text-5xl font-bold leading-10 text-gray-800 mb-4 text-center xl:text-left md:mt-0 mt-4 dark:text-[#E1E7EF]">
            Subscribe
          </h1>
          <p className="text-base leading-normal dark:text-[#E1E7EF]  text-gray-600 text-center xl:text-left">
            Whether Travel spirits new her covered hastily sitting her. Money
          ...
          <div className="flex items-stretch mt-12">
            ...
            />
            <button className="w-32 dark:text-[#E1E7EF] rounded-l-none hover:bg-indigo-600 bg-indigo-700 rounded text-base font-medium leading-none text-white p-5 uppercase focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">
              subscribe
            </button>
          </div>
        </div>
